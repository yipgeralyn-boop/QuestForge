// data.jsx — QuestForge theme tokens, icons, and sample quest data
// Exports to window: THEMES, MAP_STYLES, FONT_SETS, Icon, SAMPLE_RACE,
//   TEAMS, ACTIVITY_META, qfWord, makeId

// ──────────────────────────────────────────────────────────
// Color themes — each sets the CSS custom properties on the app root
// ──────────────────────────────────────────────────────────
const THEMES = {
  sunset: {
    label: 'Sunset Quest',
...
// ──────────────────────────────────────────────────────────
// Map paint sets — independent of theme; pins use theme colors
// ──────────────────────────────────────────────────────────
const MAP_STYLES = {
  parchment: {
    label: 'Parchment',
...
// ──────────────────────────────────────────────────────────
// Icon set — lucide-flavoured, inherits currentColor
// ──────────────────────────────────────────────────────────
const ICON_PATHS = {
...
// ──────────────────────────────────────────────────────────
// Leaderboard teams (your team = Compass Crew)
// ──────────────────────────────────────────────────────────
const TEAMS = [
...
function qfWord(t, which) {
  // which: 'quest' | 'quests' | 'Quest' | 'Quests'
  const map = {
    quest: { quest: 'quest', race: 'race', adventure: 'adventure', mission: 'mission' },
  };
  const base = (t && t.questWord) || 'quest';
  const word = map.quest[base] || 'quest';
  const plural = word + 's';
  switch (which) {
...
let _idn = 100;
function makeId() { _idn += 1; return 'x' + _idn; }

Object.assign(window, {
  THEMES, MAP_STYLES, FONT_SETS, Icon, SAMPLE_RACE, TEAMS, ACTIVITY_META, qfWord, makeId,
});
